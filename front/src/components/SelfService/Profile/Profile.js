...
const Profile = () => {
  ...
  // console.log(profile?.profileData?.ProfileEditAccess, "ProfileEditAccess");

  const getProfileEditAccessData = profile?.profilesList?.find(
    (item) => item?._id === profile?.userAuth?._id
  );
  // console.log(
  //   getProfileEditAccessData?.ProfileEditAccess,
  //   "getProfileEditAccessData"
  // );
  console.log(managerDataId, "profileData");
  return (
    <div>
